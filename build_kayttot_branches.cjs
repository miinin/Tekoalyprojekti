...
const b5 = [{top:54.9,left:45.6},{top:52.8,left:45.5}];
...
const paths = {
  ...
  'kayttotaidot_jun_5-kayttotaidot_7': strify(main.slice(17, 20)) // jun_5 to 7
};
...
out += `\n      }\n    }`;
require('fs').writeFileSync('kayttotaidot_payload2.js', out);
console.log('Done');
