                        ...
                        <div style={{ display: 'flex', flexDirection: 'column', gap: '1.8rem' }}>
                            ...
                            <div style={{ background: 'linear-gradient(135deg, #0f172a 0%, #1e293b 100%)', padding: '2rem', borderRadius: '24px', border: '1px solid #334155', boxShadow: '0 15px 40px rgba(0,0,0,0.2)' }}>
                                ...
                                <div style={{ display: 'flex', gap: '1rem', flexWrap: 'wrap' }}>
                                    <button onClick={() => giveSparksToAll(10)} style={{ background: 'linear-gradient(135deg, #fcd34d 0%, #f59e0b 100%)', color: '#78350f', padding: '0.8rem 1.5rem', display: 'flex', alignItems: 'center', gap: '0.5rem', fontSize: '1.1rem', border: 'none', borderRadius: '14px', fontWeight: 'bold', cursor: 'pointer', boxShadow: '0 4px 15px rgba(245, 158, 11, 0.3)', transition: 'all 0.2s' }} onMouseOver={e=>{e.currentTarget.style.transform='translateY(-3px)'; e.currentTarget.style.boxShadow='0 8px 20px rgba(245, 158, 11, 0.4)'}} onMouseOut={e=>{e.currentTarget.style.transform='translateY(0)'; e.currentTarget.style.boxShadow='0 4px 15px rgba(245, 158, 11, 0.3)'}}>
                                        Anna 10 Kipinää <Zap size={18} fill="#78350f"/>
                                    </button>
                                    <button onClick={() => giveSparksToAll(50)} style={{ background: 'linear-gradient(135deg, #f59e0b 0%, #d97706 100%)', color: 'white', padding: '0.8rem 1.5rem', display: 'flex', alignItems: 'center', gap: '0.5rem', fontSize: '1.1rem', border: 'none', borderRadius: '14px', fontWeight: 'bold', cursor: 'pointer', boxShadow: '0 4px 15px rgba(217, 119, 6, 0.3)', transition: 'all 0.2s' }} onMouseOver={e=>{e.currentTarget.style.transform='translateY(-3px)'; e.currentTarget.style.boxShadow='0 8px 20px rgba(217, 119, 6, 0.4)'}} onMouseOut={e=>{e.currentTarget.style.transform='translateY(0)'; e.currentTarget.style.boxShadow='0 4px 15px rgba(217, 119, 6, 0.3)'}}>
                                        Anna 50 Kipinää <Zap size={18} fill="white"/>
                                    </button>
                                    <button onClick={() => giveBoostToAll('red', 1)} style={{ background: 'linear-gradient(135deg, #ef4444 0%, #b91c1c 100%)', color: 'white', border: '1px solid #f87171', padding: '0.8rem 1.5rem', borderRadius: '14px', fontSize: '1.1rem', fontWeight: 'bold', cursor: 'pointer', display: 'flex', alignItems: 'center', gap: '0.5rem', boxShadow: '0 4px 15px rgba(239, 68, 68, 0.3)', transition: 'all 0.2s' }} onMouseOver={e=>{e.currentTarget.style.transform='translateY(-3px)'; e.currentTarget.style.boxShadow='0 8px 20px rgba(239, 68, 68, 0.4)'}} onMouseOut={e=>{e.currentTarget.style.transform='translateY(0)'; e.currentTarget.style.boxShadow='0 4px 15px rgba(239, 68, 68, 0.3)'}}>
                                        <ShieldCheck size={18} /> +1 Uusinta
                                    </button>
                                </div>
                            </div>
                                    ...
                                    <div style={{ display: 'flex', gap: '2rem', alignItems: 'center', flexWrap: 'wrap' }}>
                                        ...
                                        <div style={{ display: 'flex', flexDirection: 'column', gap: '0.6rem' }}>
                                            <div style={{ display: 'flex', gap: '0.6rem' }}>
                                                <button onClick={() => giveSparks(p.id, 50)} style={{ background: 'linear-gradient(135deg, #fef3c7 0%, #fde68a 100%)', color: '#d97706', border: '1px solid #fcd34d', padding: '0.6rem 1rem', borderRadius: '10px', cursor: 'pointer', fontWeight: 'bold', display: 'flex', alignItems: 'center', gap: '0.4rem', transition: 'all 0.2s', boxShadow: '0 2px 5px rgba(245, 158, 11, 0.1)' }} onMouseOver={e=>e.currentTarget.style.transform='translateY(-2px)'} onMouseOut={e=>e.currentTarget.style.transform='translateY(0)'} title="Anna 50 Kipinää">
                                                    +50 <Zap size={16} fill="#d97706" />
                                                </button>
                                                <button onClick={() => giveSparks(p.id, 100)} style={{ background: 'linear-gradient(135deg, #fed7aa 0%, #ffedd5 100%)', color: '#c2410c', border: '1px solid #fdba74', padding: '0.6rem 1rem', borderRadius: '10px', cursor: 'pointer', fontWeight: 'bold', display: 'flex', alignItems: 'center', gap: '0.4rem', transition: 'all 0.2s', boxShadow: '0 2px 5px rgba(194, 65, 12, 0.1)' }} onMouseOver={e=>e.currentTarget.style.transform='translateY(-2px)'} onMouseOut={e=>e.currentTarget.style.transform='translateY(0)'} title="Anna 100 Kipinää">
                                                    +100 <Zap size={16} fill="#c2410c" />
                                                </button>
                                                <button onClick={() => giveSparks(p.id, 500)} style={{ background: 'linear-gradient(135deg, #f59e0b 0%, #d97706 100%)', color: 'white', border: 'none', padding: '0.6rem 1rem', borderRadius: '10px', cursor: 'pointer', fontWeight: 'bold', display: 'flex', alignItems: 'center', gap: '0.4rem', transition: 'all 0.2s', boxShadow: '0 4px 10px rgba(217, 119, 6, 0.3)' }} onMouseOver={e=>e.currentTarget.style.transform='translateY(-2px)'} onMouseOut={e=>e.currentTarget.style.transform='translateY(0)'} title="Anna 500 Kipinää!">
                                                    +500 <Zap size={16} fill="white" />
                                                </button>
                                            </div>
                                            <div style={{ display: 'flex', gap: '0.6rem' }}>
                                                <button onClick={() => giveBoost(p.id, 'red', 1)} style={{ background: 'white', color: '#ef4444', border: '2px solid #ef4444', padding: '0.5rem 0.8rem', borderRadius: '10px', cursor: 'pointer', fontWeight: 'bold', display: 'flex', alignItems: 'center', gap: '0.4rem', transition: 'all 0.2s' }} onMouseOver={e=>{e.currentTarget.style.background='#ef4444'; e.currentTarget.style.color='white'}} onMouseOut={e=>{e.currentTarget.style.background='white'; e.currentTarget.style.color='#ef4444'}} title="Anna 1 Uusinta">
                                                    <ShieldCheck size={16} /> +1 Uusinta
                                                </button>
                                                <button onClick={() => giveBoost(p.id, 'yellow', 1)} style={{ background: 'white', color: '#eab308', border: '2px solid #eab308', padding: '0.5rem 0.8rem', borderRadius: '10px', cursor: 'pointer', fontWeight: 'bold', display: 'flex', alignItems: 'center', gap: '0.4rem', transition: 'all 0.2s' }} onMouseOver={e=>{e.currentTarget.style.background='#eab308'; e.currentTarget.style.color='white'}} onMouseOut={e=>{e.currentTarget.style.background='white'; e.currentTarget.style.color='#eab308'}} title="Anna 1 Poisto">
                                                    <Disc size={16} /> +1 Poisto
                                                </button>
                                                <button onClick={() => giveBoost(p.id, 'green', 1)} style={{ background: 'white', color: '#22c55e', border: '2px solid #22c55e', padding: '0.5rem 0.8rem', borderRadius: '10px', cursor: 'pointer', fontWeight: 'bold', display: 'flex', alignItems: 'center', gap: '0.4rem', transition: 'all 0.2s' }} onMouseOver={e=>{e.currentTarget.style.background='#22c55e'; e.currentTarget.style.color='white'}} onMouseOut={e=>{e.currentTarget.style.background='white'; e.currentTarget.style.color='#22c55e'}} title="Anna 1 Vaihto">
