...
export default function Garage() {
  ...
  const carUpgrades = [
    ...
    { id: 'van-extra07', category: 'extra', categoryName: 'Erityisosat', name: 'Erämaa-antenni', desc: 'Jotta poppi pauhaa erämaassakin.', price: 700, icon: <Radio size={28} />, color: '#eab308', bg: '#fef08a', buff: { title: 'Väärän vaihtoehdon poisto', desc: 'Antaa +3 Poistoa Konepellin alle -kartalla!' } },
  ];
