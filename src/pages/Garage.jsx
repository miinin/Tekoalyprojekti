...
export default function Garage() {
  ...
  const carUpgrades = [
    ...
    { id: 'van-wheel06', category: 'wheel', categoryName: 'Renkaat ja vanteet', name: 'Talvirenkaat', desc: 'Pitoa liukkaille.', price: 800, icon: <Disc size={28} />, color: '#eab308', bg: '#fef08a', buff: { title: 'Väärän vaihtoehdon poisto', desc: 'Antaa +2 Poistoa per kartta ja tämän lisäksi +3 Poistoa Reilu peli -kartalla!' } },
