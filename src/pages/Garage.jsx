...
export default function Garage() {
  ...
  const garageUpgrades = [
    ...
    { id: 'g-walltools6', category: 'g_tools', categoryName: 'Työkalut', name: '"Paremman puutteessa" -työkalut', desc: 'Näilläkin saa jotain aikaiseksi.', price: 600, icon: <Wrench size={28} />, color: '#22c55e', bg: '#dcfce7', buff: { title: 'Kysymyksen vaihto', desc: 'Antaa +4 Vaihtoa per kartta!' } },
    { id: 'g-walltools5', category: 'g_tools', categoryName: 'Työkalut', name: '"Ihan ok" -työkalut', desc: 'Ajaa asiansa.', price: 1000, icon: <Wrench size={28} />, color: '#22c55e', bg: '#dcfce7', buff: { title: 'Kysymyksen vaihto', desc: 'Antaa +5 Vaihtoa per kartta!' } },
