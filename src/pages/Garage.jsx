...
export default function Garage() {
  ...
  const carUpgrades = [
    ...
    { id: 'van-bumper03', category: 'bumper', categoryName: 'Puskurit', name: 'Kultapuskuri', desc: 'Bling bling!', price: 1500, icon: <ShieldCheck size={28} />, color: '#ef4444', bg: '#fee2e2', buff: { title: 'Uusi yritys', desc: 'Antaa +6 Uutta yritystä väärin menneisiin kysymyksiin per kartta!' } },
    ...
    { id: 'van-wheel04', category: 'wheel', categoryName: 'Renkaat ja vanteet', name: 'Maastorenkaat', desc: 'Järeään käyttöön.', price: 150, icon: <Disc size={28} />, color: '#eab308', bg: '#fef08a', buff: { title: 'Väärän vaihtoehdon poisto', desc: 'Antaa +2 Poistoa per kartta!' } },
    { id: 'van-wheel02', category: 'wheel', categoryName: 'Renkaat ja vanteet', name: 'Alumiinivanteet', desc: 'Kevyet ja tyylikkäät.', price: 300, icon: <Aperture size={28} />, color: '#eab308', bg: '#fef08a', buff: { title: 'Väärän vaihtoehdon poisto', desc: 'Antaa +3 Poistoa per kartta!' } },
    { id: 'van-wheel03', category: 'wheel', categoryName: 'Renkaat ja vanteet', name: 'Erikoisvanteet', desc: 'Kun vain paras kelpaa.', price: 600, icon: <Sparkles size={28} />, color: '#eab308', bg: '#fef08a', buff: { title: 'Väärän vaihtoehdon poisto', desc: 'Antaa +4 Poistoa per kartta!' } },
    { id: 'van-wheel05', category: 'wheel', categoryName: 'Renkaat ja vanteet', name: 'Vintage-vanteet', desc: 'Tyylikästä nostalgiaa.', price: 1000, icon: <Disc size={28} />, color: '#eab308', bg: '#fef08a', buff: { title: 'Väärän vaihtoehdon poisto', desc: 'Antaa +5 Poistoa per kartta!' } },
    { id: 'van-wheel06', category: 'wheel', categoryName: 'Renkaat ja vanteet', name: 'Talvirenkaat', desc: 'Pitoa liukkaille.', price: 800, icon: <Disc size={28} />, color: '#eab308', bg: '#fef08a', buff: { title: 'Väärän vaihtoehdon poisto', desc: 'Antaa +2 Poistoa per kartta ja tämän lisäksi +3 Poistoa Tekoälyn käyttötaidot -kartalla!' } },

    // EXTRA
    { id: 'van-extra01', category: 'extra', categoryName: 'Erityisosat', name: 'Roots-ahdin', desc: 'Lisää tehoa konepellille!', price: 2000, icon: <Flame size={28} />, color: '#f59e0b', bg: '#fef3c7', buff: { title: 'Ahdettu ketju', desc: 'Kipinäketju putoaa väärästä vastauksesta nollan sijasta viiteen.', isSpark: true } },
    { id: 'van-extra02', category: 'extra', categoryName: 'Erityisosat', name: 'Työkalusarja vaativiin oloihin', desc: 'Valmiina kaikkiin remontteihin tien päällä.', price: 1000, icon: <Wrench size={28} />, color: '#22c55e', bg: '#dcfce7', buff: { title: 'Kysymyksen vaihto', desc: 'Antaa +1 Vaihtoa per kartta' } },
    { id: 'van-extra03', category: 'extra', categoryName: 'Erityisosat', name: 'Taakkateline ja lisävalot', desc: 'Taakkateline ja lisävalot katolle.', price: 1500, icon: <Flame size={28} />, color: '#6366f1', bg: '#e0e7ff', buff: { title: 'Parempi näkyvyys', desc: 'Ensimmäinen väärä vastaus ei katkaise Kipinäketjua.', isSpark: true } },
    { id: 'van-extra04', category: 'extra', categoryName: 'Erityisosat', name: 'Vinssi', desc: 'Vinssi, jolla kapuaa korkeimmallekin vuorelle.', price: 800, icon: <ShieldCheck size={28} />, color: '#22c55e', bg: '#dcfce7', buff: { title: 'Kysymyksen vaihto', desc: 'Antaa +3 Vaihtoa Aivoterveys-kartalla!' } },
    ...
    { id: 'van-extra07', category: 'extra', categoryName: 'Erityisosat', name: 'Erämaa-antenni', desc: 'Jotta poppi pauhaa erämaassakin.', price: 700, icon: <Radio size={28} />, color: '#eab308', bg: '#fef08a', buff: { title: 'Väärän vaihtoehdon poisto', desc: 'Antaa +3 Poistoa Tekoäly arjessamme -kartalla!' } },
  ];
  ...
  const garageUpgrades = [
    ...
    { id: 'g-walls2', category: 'g_walls', categoryName: 'Seinät', name: 'Syväpuhdistus', desc: 'Korjaa ja syväpuhdistaa seinät.', price: 1200, icon: <Layers size={28} />, color: '#64748b', bg: '#f1f5f9', buff: { title: 'Puhdas talli!', desc: 'Saat oikeista vastauksista +10% enemmän kipinöitä', isSpark: true } },
    ...
    { id: 'g-walltools1', category: 'g_tools', categoryName: 'Työkalut', name: 'Työkalusarja', desc: 'Perustyökalut esille.', price: 150, icon: <Wrench size={28} />, color: '#22c55e', bg: '#dcfce7', buff: { title: 'Kysymyksen vaihto', desc: 'Antaa +2 Vaihtoa per kartta!' } },
    { id: 'g-walltools2', category: 'g_tools', categoryName: 'Työkalut', name: 'Parannetut työkalut', desc: 'Kattavampi setti harrastajalle.', price: 300, icon: <Wrench size={28} />, color: '#22c55e', bg: '#dcfce7', buff: { title: 'Kysymyksen vaihto', desc: 'Antaa +3 Vaihtoa per kartta!' } },
    { id: 'g-walltools6', category: 'g_tools', categoryName: 'Työkalut', name: '"Paremman puutteessa" -työkalut', desc: 'Näilläkin saa jotain aikaiseksi.', price: 1200, icon: <Wrench size={28} />, color: '#22c55e', bg: '#dcfce7', buff: { title: 'Kysymyksen vaihto', desc: 'Antaa +4 Vaihtoa per kartta!' } },
    { id: 'g-walltools5', category: 'g_tools', categoryName: 'Työkalut', name: '"Ihan ok" -työkalut', desc: 'Ajaa asiansa.', price: 1200, icon: <Wrench size={28} />, color: '#22c55e', bg: '#dcfce7', buff: { title: 'Kysymyksen vaihto', desc: 'Antaa +5 Vaihtoa per kartta!' } },
    { id: 'g-walltools3', category: 'g_tools', categoryName: 'Työkalut', name: 'Huipputyökalut', desc: 'Kaikki mitä ammattilainen tarvitsee.', price: 1200, icon: <Sparkles size={28} />, color: '#22c55e', bg: '#dcfce7', buff: { title: 'Kysymyksen vaihto', desc: 'Antaa +6 Vaihtoa per kartta!' } },
    { id: 'g-walltools4', category: 'g_tools', categoryName: 'Työkalut', name: 'Tulevaisuuden työkalut', desc: 'Tulevaisuuden tekijöille.', price: 2000, icon: <Zap size={28} />, color: '#22c55e', bg: '#dcfce7', buff: { title: 'Kysymyksen vaihto', desc: 'Antaa huikeat +7 Vaihtoa per kartta!' } },

    // TUNKIT (Sininen ominaisuus -> Nyt Punainen)
    { id: 'g-jack1', category: 'g_jack', categoryName: 'Tunkit', name: 'Perustunkki', desc: 'Nostaa auton turvallisesti.', price: 500, icon: <Disc size={28} />, color: '#ef4444', bg: '#fee2e2', buff: { title: 'Uusi yritys', desc: 'Satunnainen mahdollisuus saada Uusi yritys Oikein vai väärin -tehtävässä.' } },
    { id: 'g-jack2', category: 'g_jack', categoryName: 'Tunkit', name: 'Laatutunkki', desc: 'Nopea ja vahva hallitunkki.', price: 1000, icon: <Disc size={28} />, color: '#ef4444', bg: '#fee2e2', buff: { title: 'Uusi yritys', desc: 'Pieni mahdollisuus saada Uusi yritys Oikein vai väärin -tehtävässä.' } },
    { id: 'g-jack3', category: 'g_jack', categoryName: 'Tunkit', name: 'Levitaatiotunkki', desc: 'Auto nousee ilmaan melkein itsestään. Maagista!', price: 2500, icon: <Aperture size={28} />, color: '#ef4444', bg: '#fee2e2', buff: { title: 'Uusi yritys', desc: 'Kohtalainen mahdollisuus saada Uusi yritys Oikein vai väärin -tehtävässä.' } }
  ];
  ...
  const renderBuffDesc = (desc) => {
    ...
    return parts.map((part, i) => {
        if (/kipinäketju/i.test(part)) {
            return <span key={i} style={{ color: '#d97706', fontWeight: '900', letterSpacing: '0.5px', padding: '0 2px' }}>{part}</span>;
        }
           ...
           <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', gap: '0.4rem', width: '100%', flexGrow: 1, position: 'relative', padding: '0.6rem' }}>
              ...
              {item.category === 'body' ? (
                  ...
                  <div style={{ 
                    ...
                    {(() => {
                        if (item.buff) {
                            if (item.buff.isSpark) return <Flame size={28} fill="currentColor" />;
                            ...
                            if (t.includes('uusi yrity')) return <Shield size={28} />;
                        }
           ...
           <div style={{ 
            ...
            background: 'radial-gradient(circle at top, #334155 0%, #0f172a 100%)'
              ...
              {completedLessons.length > 0 && !closedGarageTuition && !isTutorialActive && !tutorialSkipped && (
               ...
               {showTrophyCabinet && (
                 <div style={{ position: 'fixed', top: 0, left: 0, right: 0, bottom: 0, background: 'rgba(0,0,0,0.6)', zIndex: 9999, display: 'flex', alignItems: 'center', justifyContent: 'center' }} onClick={() => setShowTrophyCabinet(false)}>
                    <div style={{ position: 'relative', width: '100%', height: '100%', display: 'flex', justifyContent: 'center', alignItems: 'center' }} onClick={e => e.stopPropagation()}>
                       ...
                       <div style={{ position: 'absolute', top: '50.66%', left: '22.17%', width: '55.42%', height: '33.95%', zIndex: 5, pointerEvents: 'none', paddingBottom: '1%' }}>
                           ...
                           {bestStreak > 0 && (
                               <div 
                                    ...
                                    style={{ position: 'absolute', top: '25%', left: '50%', transform: 'translate(-50%, -50%)', zIndex: hoverPlaque ? 20 : 1, background: 'linear-gradient(145deg, #fef08a, #d97706)', padding: '0.4rem 1.4rem', borderRadius: '8px', border: '3px solid #78350f', boxShadow: '0 8px 25px rgba(0,0,0,0.5), inset 0 2px 10px rgba(255,255,255,0.4)', display: 'flex', alignItems: 'center', gap: '0.6rem', pointerEvents: 'auto', cursor: 'help' }}>
                     ...
                     {selectedTrophyObj && (
                        <div className="animate-fade-in" style={{ position: 'fixed', top: 0, left: 0, right: 0, bottom: 0, background: 'rgba(0,0,0,0.85)', zIndex: 10000, display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center' }} onClick={(e) => { e.stopPropagation(); setSelectedTrophyObj(null); }}>
              ...
              {hoveredObj && hoveredObj.buff && (
                <div className="animate-fade-in" style={{ position: 'absolute', top: '1.5rem', left: '1.5rem', background: 'rgba(255, 255, 255, 0.95)', padding: '1.2rem', borderRadius: '16px', borderLeft: `6px solid ${hoveredObj.buff.isSpark ? '#f59e0b' : (hoveredObj.color || '#22c55e')}`, color: 'var(--text-main)', zIndex: 20, boxShadow: '0 15px 30px rgba(0,0,0,0.4)', maxWidth: '350px' }}>
                   <div style={{ display: 'flex', alignItems: 'center', gap: '0.6rem', marginBottom: '0.5rem', color: hoveredObj.buff.isSpark ? '#d97706' : (hoveredObj.color || '#166534') }}>
                      {(() => {
                           if (hoveredObj.buff.isSpark) return <Flame size={18} fill="currentColor" />;
                           if (hoveredObj.id === 'van-wheel06') return <Snowflake size={18} />;
                           const t = (hoveredObj.buff.title || '').toLowerCase();
                           if (t.includes('vaihto')) return <RefreshCw size={18} />;
                           if (t.includes('poisto')) return <Eraser size={18} />;
                           if (t.includes('uusi yrity')) return <Shield size={18} />;
                           return <div style={{ width: '12px', height: '12px', borderRadius: '50%', background: hoveredObj.color || '#22c55e', border: '1px solid rgba(0,0,0,0.2)', boxShadow: `0 0 8px ${hoveredObj.color || '#22c55e'}, inset 0 2px 4px rgba(255,255,255,0.8)` }} />;
                      })()}
                      <span style={{ fontWeight: '900', fontSize: '1.1rem', textTransform: 'uppercase', letterSpacing: '0.5px', textShadow: '0 1px 1px rgba(0,0,0,0.1)' }}>{hoveredObj.buff.title}</span>
                   </div>
                   <div style={{ fontSize: '0.95rem', lineHeight: '1.5', color: '#334155', fontWeight: '500' }}>
                      {renderBuffDesc(hoveredObj.buff.desc)}
                   </div>
                </div>
              )}
