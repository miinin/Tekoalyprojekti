...
export default function Garage() {
  ...
  const garageUpgrades = [
    ...
    { id: 'g-walltools4', category: 'g_tools', categoryName: 'Työkalut', name: 'Tulevaisuuden työkalut', desc: 'Tulevaisuuden tekijöille.', price: 3000, icon: <Zap size={28} />, color: '#854d0e', bg: '#fef08a', buff: { title: 'Tulevaisuuden Avustin (Taso 4)', desc: 'Järjestely-tehtävissä näet kaikki väärässä olevat palikat ja AIvan lukitsee 1 palikan jo valmiiksi!' } },

    // TUNKIT (Mutually Exclusive)
    { id: 'g-jack1', category: 'g_jack', categoryName: 'Tunkit', name: 'Perustunkki', desc: 'Nostaa auton turvallisesti.', price: 500, icon: <Disc size={28} />, color: '#64748b', bg: '#f1f5f9', buff: { title: 'Putoamisen esto (Taso 1)', desc: 'Satunnainen mahdollisuus pelastua mitalin menetykseltä True/False -tehtävässä.' } },
    { id: 'g-jack2', category: 'g_jack', categoryName: 'Tunkit', name: 'Laatutunkki', desc: 'Nopea ja vahva hallitunkki.', price: 1000, icon: <Disc size={28} />, color: '#475569', bg: '#f1f5f9', buff: { title: 'Putoamisen esto (Taso 2)', desc: 'Pieni mahdollisuus pelastua mitalin menetykseltä True/False -tehtävässä.' } },
    { id: 'g-jack3', category: 'g_jack', categoryName: 'Tunkit', name: 'Levitaatiotunkki', desc: 'Auto nousee ilmaan melkein itsestään. Maagista!', price: 2500, icon: <Aperture size={28} />, color: '#334155', bg: '#f1f5f9', buff: { title: 'Levitaatio (Taso 3)', desc: 'Kohtalainen mahdollisuus pelastua mitalin menetykseltä True/False -tehtävässä.' } }
  ];
