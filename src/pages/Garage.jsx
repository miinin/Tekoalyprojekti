...
export default function Garage() {
  ...
  const carUpgrades = [
    ...
    { id: 'van-bumper05', category: 'bumper', categoryName: 'Puskurit', name: 'Rustiikkinen puskuri', desc: 'Rouheaa asennetta huokuva teräs.', price: 150, icon: <ShieldCheck size={28} />, color: '#ef4444', bg: '#fee2e2', buff: { title: 'Uusi yritys', desc: <>Antaa +2 <span style={{ fontFamily: 'var(--font-display)', fontWeight: 900, color: '#ef4444' }}>Uutta yritystä</span> väärin menneisiin kysymyksiin per kartta!</> } },
    { id: 'van-bumper02', category: 'bumper', categoryName: 'Puskurit', name: 'Kromipuskuri', desc: 'Kiiltävää näyttävyyttä.', price: 300, icon: <ShieldCheck size={28} />, color: '#ef4444', bg: '#fee2e2', buff: { title: 'Uusi yritys', desc: <>Antaa +3 <span style={{ fontFamily: 'var(--font-display)', fontWeight: 900, color: '#ef4444' }}>Uutta yritystä</span> väärin menneisiin kysymyksiin per kartta!</> } },
    { id: 'van-bumper04', category: 'bumper', categoryName: 'Puskurit', name: 'Mattamusta', desc: 'Hillitty ja moderni.', price: 600, icon: <ShieldCheck size={28} />, color: '#ef4444', bg: '#fee2e2', buff: { title: 'Uusi yritys', desc: <>Antaa +4 <span style={{ fontFamily: 'var(--font-display)', fontWeight: 900, color: '#ef4444' }}>Uutta yritystä</span> väärin menneisiin kysymyksiin per kartta!</> } },
    { id: 'van-bumper06', category: 'bumper', categoryName: 'Puskurit', name: 'Pronssipuskuri', desc: 'Hillityn arvokas.', price: 1000, icon: <ShieldCheck size={28} />, color: '#ef4444', bg: '#fee2e2', buff: { title: 'Uusi yritys', desc: <>Antaa +5 <span style={{ fontFamily: 'var(--font-display)', fontWeight: 900, color: '#ef4444' }}>Uutta yritystä</span> väärin menneisiin kysymyksiin per kartta!</> } },
    { id: 'van-bumper03', category: 'bumper', categoryName: 'Puskurit', name: 'Kultapuskuri', desc: 'Bling bling!', price: 1500, icon: <ShieldCheck size={28} />, color: '#ef4444', bg: '#fee2e2', buff: { title: 'Uusi yritys', desc: <>Antaa +6 <span style={{ fontFamily: 'var(--font-display)', fontWeight: 900, color: '#ef4444' }}>Uutta yritystä</span> väärin menneisiin kysymyksiin per kartta!</> } },
    ...
    { id: 'van-wheel04', category: 'wheel', categoryName: 'Renkaat ja vanteet', name: 'Maastorenkaat', desc: 'Järeään käyttöön.', price: 150, icon: <Disc size={28} />, color: '#eab308', bg: '#fef08a', buff: { title: 'Väärän vaihtoehdon poisto', desc: <>Antaa +2 <span style={{ fontFamily: 'var(--font-display)', fontWeight: 900, color: '#eab308' }}>Poistoa</span> per kartta!</> } },
    { id: 'van-wheel02', category: 'wheel', categoryName: 'Renkaat ja vanteet', name: 'Alumiinivanteet', desc: 'Kevyet ja tyylikkäät.', price: 300, icon: <Aperture size={28} />, color: '#eab308', bg: '#fef08a', buff: { title: 'Väärän vaihtoehdon poisto', desc: <>Antaa +3 <span style={{ fontFamily: 'var(--font-display)', fontWeight: 900, color: '#eab308' }}>Poistoa</span> per kartta!</> } },
    { id: 'van-wheel03', category: 'wheel', categoryName: 'Renkaat ja vanteet', name: 'Erikoisvanteet', desc: 'Kun vain paras kelpaa.', price: 600, icon: <Sparkles size={28} />, color: '#eab308', bg: '#fef08a', buff: { title: 'Väärän vaihtoehdon poisto', desc: <>Antaa +4 <span style={{ fontFamily: 'var(--font-display)', fontWeight: 900, color: '#eab308' }}>Poistoa</span> per kartta!</> } },
    { id: 'van-wheel05', category: 'wheel', categoryName: 'Renkaat ja vanteet', name: 'Vintage-vanteet', desc: 'Tyylikästä nostalgiaa.', price: 1000, icon: <Disc size={28} />, color: '#eab308', bg: '#fef08a', buff: { title: 'Väärän vaihtoehdon poisto', desc: <>Antaa +5 <span style={{ fontFamily: 'var(--font-display)', fontWeight: 900, color: '#eab308' }}>Poistoa</span> per kartta!</> } },
    { id: 'van-wheel06', category: 'wheel', categoryName: 'Renkaat ja vanteet', name: 'Talvirenkaat', desc: 'Pitoa liukkaille.', price: 800, icon: <Disc size={28} />, color: '#eab308', bg: '#fef08a', buff: { title: 'Väärän vaihtoehdon poisto', desc: <>Antaa +2 <span style={{ fontFamily: 'var(--font-display)', fontWeight: 900, color: '#eab308' }}>Poistoa</span> per kartta ja tämän lisäksi +3 <span style={{ fontFamily: 'var(--font-display)', fontWeight: 900, color: '#eab308' }}>Poistoa</span> Reilu peli -kartalla!</> } },
    ...
    { id: 'van-extra04', category: 'extra', categoryName: 'Erityisosat', name: 'Vinssi', desc: 'Vinssi, jolla kapuaa korkeimmallekin vuorelle.', price: 800, icon: <ShieldCheck size={28} />, color: '#22c55e', bg: '#dcfce7', buff: { title: 'Kysymyksen vaihto', desc: <>Antaa +3 <span style={{ fontFamily: 'var(--font-display)', fontWeight: 900, color: '#22c55e' }}>Vaihtoa</span> Aivoterveys-kartalla!</> } },
    ...
    { id: 'van-extra06', category: 'extra', categoryName: 'Erityisosat', name: 'Snorkkeli', desc: 'Vedenaalaisiin seikkailuihin.', price: 1000, icon: <Map size={28} />, color: '#ef4444', bg: '#fee2e2', buff: { title: 'Uusi yritys', desc: <>Antaa +3 <span style={{ fontFamily: 'var(--font-display)', fontWeight: 900, color: '#ef4444' }}>Uutta yritystä</span> Digiturva-kartalla!</> } },
    { id: 'van-extra07', category: 'extra', categoryName: 'Erityisosat', name: 'Erämaa-antenni', desc: 'Jotta poppi pauhaa erämaassakin.', price: 700, icon: <Radio size={28} />, color: '#eab308', bg: '#fef08a', buff: { title: 'Väärän vaihtoehdon poisto', desc: <>Antaa +3 <span style={{ fontFamily: 'var(--font-display)', fontWeight: 900, color: '#eab308' }}>Poistoa</span> Konepellin alle -kartalla!</> } }
  ];
  ...
  const garageUpgrades = [
    ...
    { id: 'g-walltools1', category: 'g_tools', categoryName: 'Työkalut', name: 'Työkalusarja', desc: 'Perustyökalut esille.', price: 150, icon: <Wrench size={28} />, color: '#22c55e', bg: '#dcfce7', buff: { title: 'Kysymyksen vaihto', desc: <>Antaa +2 <span style={{ fontFamily: 'var(--font-display)', fontWeight: 900, color: '#22c55e' }}>Vaihtoa</span> per kartta!</> } },
    { id: 'g-walltools2', category: 'g_tools', categoryName: 'Työkalut', name: 'Parannetut työkalut', desc: 'Kattavampi setti harrastajalle.', price: 300, icon: <Wrench size={28} />, color: '#22c55e', bg: '#dcfce7', buff: { title: 'Kysymyksen vaihto', desc: <>Antaa +3 <span style={{ fontFamily: 'var(--font-display)', fontWeight: 900, color: '#22c55e' }}>Vaihtoa</span> per kartta!</> } },
    { id: 'g-walltools6', category: 'g_tools', categoryName: 'Työkalut', name: '"Paremman puutteessa" -työkalut', desc: 'Näilläkin saa jotain aikaiseksi.', price: 600, icon: <Wrench size={28} />, color: '#22c55e', bg: '#dcfce7', buff: { title: 'Kysymyksen vaihto', desc: <>Antaa +4 <span style={{ fontFamily: 'var(--font-display)', fontWeight: 900, color: '#22c55e' }}>Vaihtoa</span> per kartta!</> } },
    { id: 'g-walltools5', category: 'g_tools', categoryName: 'Työkalut', name: '"Ihan ok" -työkalut', desc: 'Ajaa asiansa.', price: 1000, icon: <Wrench size={28} />, color: '#22c55e', bg: '#dcfce7', buff: { title: 'Kysymyksen vaihto', desc: <>Antaa +5 <span style={{ fontFamily: 'var(--font-display)', fontWeight: 900, color: '#22c55e' }}>Vaihtoa</span> per kartta!</> } },
    { id: 'g-walltools3', category: 'g_tools', categoryName: 'Työkalut', name: 'Huipputyökalut', desc: 'Kaikki mitä ammattilainen tarvitsee.', price: 1500, icon: <Sparkles size={28} />, color: '#22c55e', bg: '#dcfce7', buff: { title: 'Kysymyksen vaihto', desc: <>Antaa +6 <span style={{ fontFamily: 'var(--font-display)', fontWeight: 900, color: '#22c55e' }}>Vaihtoa</span> per kartta!</> } },
    { id: 'g-walltools4', category: 'g_tools', categoryName: 'Työkalut', name: 'Tulevaisuuden työkalut', desc: 'Tulevaisuuden tekijöille.', price: 2000, icon: <Zap size={28} />, color: '#22c55e', bg: '#dcfce7', buff: { title: 'Kysymyksen vaihto', desc: <>Antaa huikeat +7 <span style={{ fontFamily: 'var(--font-display)', fontWeight: 900, color: '#22c55e' }}>Vaihtoa</span> per kartta!</> } },

    // TUNKIT (Sininen ominaisuus -> Nyt Punainen)
    { id: 'g-jack1', category: 'g_jack', categoryName: 'Tunkit', name: 'Perustunkki', desc: 'Nostaa auton turvallisesti.', price: 500, icon: <Disc size={28} />, color: '#ef4444', bg: '#fee2e2', buff: { title: 'Uusi yritys', desc: <>Satunnainen mahdollisuus saada <span style={{ fontFamily: 'var(--font-display)', fontWeight: 900, color: '#ef4444' }}>Uusi yritys</span> Oikein vai väärin -tehtävässä.</> } },
    { id: 'g-jack2', category: 'g_jack', categoryName: 'Tunkit', name: 'Laatutunkki', desc: 'Nopea ja vahva hallitunkki.', price: 1000, icon: <Disc size={28} />, color: '#ef4444', bg: '#fee2e2', buff: { title: 'Uusi yritys', desc: <>Pieni mahdollisuus saada <span style={{ fontFamily: 'var(--font-display)', fontWeight: 900, color: '#ef4444' }}>Uusi yritys</span> Oikein vai väärin -tehtävässä.</> } },
    { id: 'g-jack3', category: 'g_jack', categoryName: 'Tunkit', name: 'Levitaatiotunkki', desc: 'Auto nousee ilmaan melkein itsestään. Maagista!', price: 2500, icon: <Aperture size={28} />, color: '#ef4444', bg: '#fee2e2', buff: { title: 'Uusi yritys', desc: <>Kohtalainen mahdollisuus saada <span style={{ fontFamily: 'var(--font-display)', fontWeight: 900, color: '#ef4444' }}>Uusi yritys</span> Oikein vai väärin -tehtävässä.</> } }
  ];
